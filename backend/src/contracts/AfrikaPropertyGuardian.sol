...
/**
 * @title AfrikaPropertyGuardian
 * @dev Smart contract for property verification and tokenization on Hedera
 * @author Afrika Property Guardian Team
 * @notice This contract enables property registration, verification, and tokenization
 */
contract AfrikaPropertyGuardian {
    ...
    modifier onlyAuthorizedVerifier() {
        require(authorizedVerifiers[msg.sender] || msg.sender == owner, "Only authorized verifier");
        _;
    }
